...
function generateToDoHTML(element, i, taskColor){
    ...
    console.log(element);
    return `<div draggable="true" onclick="openContainer('${element['title']}', '${element['description']}', '${element['due_date']}')" ondragstart="startdragging(${i}, '${element['state']}')" class="taskContainer ${taskColor}">${element['title']}</div>
...
function openContainer(title, description, due_date){
    ...
    <div class="assignedUser"><p>Assigned To: <span id="users_assigned"></span> </p></div>
